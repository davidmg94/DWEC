...
} from "./Excepciones_Restaurantes.js";
...
class RestaurantsManager {
   ...
   //Función que devuelve una instancia unica de Restaurants Manager si ya existe, sino crea una nueva.
   static getInstance() {
      if (!this[instance]) {
   ...
   // Generadores para obtener iteradores de categorías, menús, alérgenos y restaurantes
   *getterCategories() {
   ...
   *getterRestaurants() {
   ...
   #sortObjects = function (objA, objB) {
      ...
      return 0; // Si los objetos no son del mismo tipo, retorna 0
   };
