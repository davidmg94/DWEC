...
function burbuja() {
    ...
    let sinOrdenar = document.getElementById("sinOrdenar");
    sinOrdenar.innerHTML = "Lista de números sin ordenar: " + array;  // Muestra el array original sin ordenar
    ...
    if (!salir) { // Si no hubo errores, muestra el array ordenado
        ...
        ordenado.innerHTML = "Lista de números ordenados: " + array;
    }
}