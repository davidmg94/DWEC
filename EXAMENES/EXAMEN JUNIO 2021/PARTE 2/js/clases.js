...
class ClubDeportivo {
   ...
   static compararPosicion(jugador1, jugador2) {
      const posicion1 = jugador1.posicion.toLowerCase();
      const posicion2 = jugador2.posicion.toLowerCase();
   ...
   static compararAltura(jugador1, jugador2) {
      return jugador1.altura - jugador2.altura;
   }

   // Métodos estáticos de comparación específicos para JugadorTenis
   static compararManoDominante(jugador1, jugador2) {
      const mano1 = jugador1.manoDominante.toLowerCase();
      const mano2 = jugador2.manoDominante.toLowerCase();
      if (mano1 < mano2) {
         return -1;
      }
      if (mano1 > mano2) {
   ...
   ordenarPorAltura() {
      this.jugadores.sort(ClubDeportivo.compararAltura);
   }
