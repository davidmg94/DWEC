...
!(function (t, e) {
   ...
   const le = {
      ...
      fn: function (t) {
         ...
         if (o && r) {
            var h = (function (t, e) {
                  return re(
                     "number" != typeof (t = "function" == typeof t ? t(Object.assign({}, e.rects, { placement: e.placement })) : t) ? t : ae(t, yt)
                  );
               })(s.padding, i),
               d = Kt(o),
               u = "y" === l ? mt : bt,
   ...
   class Mn extends B {
      ...
      _getConfig(t) {
         return (
            (t = { ...jn, ...U.getDataAttributes(this._element), ...("object" == typeof t && t ? t : {}) }), a(Dn, t, this.constructor.DefaultType), t
         );
      }
      _maybeScheduleHide() {
